...
export interface FileEvent {
  ...
  timestamp: string;
  eventType:
    | typeof NotificationServiceEventTypes.FILE_UPLOADED
    | typeof NotificationServiceEventTypes.FILE_PROCESSED
    | typeof NotificationServiceEventTypes.FILE_DELETED;
...
export type NotificationServiceEventType =
  (typeof NotificationServiceEventTypes)[keyof typeof NotificationServiceEventTypes];
